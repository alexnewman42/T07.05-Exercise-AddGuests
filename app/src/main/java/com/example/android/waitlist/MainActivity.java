...
public class MainActivity extends AppCompatActivity {
    ...
    public void addToWaitlist(View view) {
        ...
        // Use Integer.parseInt to parse mNewPartySizeEditText.getText to an integer. Surround the Integer.parseInt with a try catch and log any exception
        try {
        ...
        // Tcall mAdapter.swapCursor to update the cursor by passing in getAllGuests()
        mAdapter.swapCursor(getAllGuests());

        // make the UI look nice, call .getText().clear() on both EditTexts, also call clearFocus() on mNewPartySizeEditText
    ...
    private long addNewGuest(String name, int partySize) {
        //a ContentValues instance to pass the values onto the insert query
        ContentValues cv = new ContentValues();
        //insert the name values with the keys
